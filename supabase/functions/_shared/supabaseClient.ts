...
function getSupabaseUrl(): string {
  ...
  // Edge Functions 运行�?Docker 容器中，需要使�?host.docker.internal 访问宿主�?  if (url.includes('127.0.0.1') || url.includes('localhost')) {
    // Windows �?Mac 使用 host.docker.internal，Linux 可能需要使用网�?IP
